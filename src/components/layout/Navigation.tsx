...
export default function Navigation() {
  ...
  const handleSignIn = () => {
    router.push('/'); // Redirect to home for portfolio showcase
  };

  const handleCTA = () => {
    router.push('/'); // Showcase portfolio work
  };
        ...
        <div className="flex h-16 items-center justify-between">
          ...
          <div className="flex-shrink-0">
            <Link href="/" className="flex items-center space-x-2">
              ...
              <span className="font-bold text-xl text-foreground">Pixel Perfect</span>
            </Link>
          </div>
        ...
        >
          <div className="px-2 pt-2 pb-3 space-y-1 border-t border-muted">
            ...
            <div className="pt-4 flex flex-col space-y-2">
              ...
              <Button
                className="justify-start group bg-primary text-primary-foreground hover:bg-primary/90"
                onClick={handleCTA}
              >
                View Portfolio
                <ArrowRight className="ml-2 size-4 transition-transform group-hover:translate-x-1" />
